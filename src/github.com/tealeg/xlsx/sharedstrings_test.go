...
// using myxlsx.MakeSharedStringRefTable().
...
// an myxlsx.xlsxSST struct and it's associated children.
...
// Test we can correctly create the myxlsx.xlsxSST struct from a RefTable
